<section id="footer">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-social-connection">
                        ...
                        <li class="list-social-connection__item">
                            <a href="javascript:;" title="youtube" class="list-social-connection__link" target="_blank">
    ...
    <div class="footer__bot">
        <div class="container">
            <h1 class="footer__logo"><a href="/" title="Pizza"><img src="assets/img/logo-the-pizza-company.png" alt="Pizza"></a></h1>
            <p class="copyright">© Copyright 2016 Pizza Ngon Joint Stock Company, 10th floor, Lottery Tower, 77 Tran Nhan Ton, District 5, Ho Chi Minh City<br>Tel. (028) 3820 6525 - E-mail. <a href="mailto:chamsockhachhang@thepizzacompany.vn"> chamsockhachhang@thepizzacompany.vn</a> </p>
        </div>
    </div>
    </div>
</section>