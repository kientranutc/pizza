...
@section('content')
    <div class="panel panel-default table-responsive">
        ...
        <div class="panel-heading">Thêm mới khuyến mại </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 {{($errors->has('title'))?'has-error':''}}">
                            <div class="form-group ">
                                ...
                                <input type="text" placeholder="Tên khuyến mại" value="{{old('title')?old('title'):''}}"  name="title" class="form-control input-sm" data-required="true">
