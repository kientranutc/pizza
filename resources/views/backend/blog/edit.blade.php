...
@section('content')
    <div class="panel panel-default table-responsive">
        ...
        <div class="panel-body">
            <form class="no-margin" id="formValidate2" action="{{URL::route('blog.edit',$data->id)}}" method="post" data-validate="parsley" novalidate>
                {{csrf_field()}}
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-6 {{($errors->has('title'))?'has-error':''}}">
                            <div class="form-group ">
                                ...
                                <input type="text" placeholder="Tên blog" value="{{old('title')?old('title'):$data->title}}"  name="title" class="form-control input-sm" data-required="true">
                        ...
                        <div class="col-md-6 {{($errors->has('image'))?'has-error':''}}">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Click để thêm ảnh" value="{{old('image')?old('image'):$data->image}}"  name="image" class="form-control input-sm input-image" id="image-input" data-required="true" data-type="url">
